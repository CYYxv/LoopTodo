...
export function SubscriptionPanel() {
  ...
  return <View className="gap-3"><Card><Card.Body className="gap-3">
    ...
    <Card.Description>基础自律功能免费；VIP 扩展主题、白噪音、更多习惯、任务型 AI/MCP 和家庭管理。</Card.Description>
    ...
    <View className="gap-1"><Text type="body-sm" weight="semibold">扩展权益</Text><Text type="body-xs" color="muted">更多习惯 · 主题与专注海报 · 白噪音 · 任务 AI/MCP · 家庭管理</Text></View>
